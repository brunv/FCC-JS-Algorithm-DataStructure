/**
 *  Regular expressions are used in programming languages to match parts of
 *  strings. You create patterns to help you do that matching.
 * 
 ...
 * 
 *  JavaScript has multiple ways to use regexes. One way to test regex is using
 *  the .test() method. This method takes the regex, applies it to a string
